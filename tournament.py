...
def play_matches(cpu_agents, test_agents, num_matches):
    ...
    print("{:^9}{:^13} {:^5}| {:^5} {:^5}| {:^5} {:^5}| {:^5} {:^5}| {:^5}".format("", "", *(["Won", "Lost"] * 4)))
...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score_3), "New fun test"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_4), "AB_Custom_3 NEW ONE")
    ]
